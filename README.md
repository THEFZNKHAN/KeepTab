...
```
Open-source Chrome extension to save tabs, links, and notes while browsing. Local-first personal board with one-click capture, clipboard export, and optional Google Keep checklist sync. MV3, TypeScript, privacy-first.
```

**Website** (optional)

```
https://github.com/THEFZNKHAN/KeepTab
```
...
```
KeepTab v2.0.0 — Save tabs, links, and notes with optional Google Keep sync
```

---

<p align="center">
  <sub>KeepTab v2.0.0 · Chrome Extension · Manifest V3 · MIT License</sub>
</p>
